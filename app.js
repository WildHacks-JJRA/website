...
function revealMaze() {
    for(var y = clickPos.y==0? 0 : clickPos.y-1; y <= (clickPos.y+1 >= maze.size? maze.size-1 : clickPos.y+1); y++) {
        for(var x = clickPos.x==0? 0 : clickPos.x-1; x <= (clickPos.x+1 >= maze.size? maze.size-1 : clickPos.x+1); x++) {
